 ...
 * @returns Formatted string with the data of members in the memberVariables dictionary.
 */
 ...
 *
 * @returns Formatted string with the data of all properties of this object.
 */
